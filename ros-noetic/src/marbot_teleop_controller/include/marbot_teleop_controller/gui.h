...
class Gui {
public:
    Gui(const std::string &resource_path) : gui_active_(true) {
        ...
        if (gui_active_) {
            unselected_wasd_[W] = Img(renderer_, SDL_LoadBMP((resource_path + "/rss/w_key.bmp").c_str()), { 110, 5, 100, 100 });
            unselected_wasd_[A] = Img(renderer_, SDL_LoadBMP((resource_path + "/rss/a_key.bmp").c_str()), { 5, 110, 100, 100 });
            unselected_wasd_[S] = Img(renderer_, SDL_LoadBMP((resource_path + "/rss/s_key.bmp").c_str()), { 110, 110, 100, 100 });
            unselected_wasd_[D] = Img(renderer_, SDL_LoadBMP((resource_path + "/rss/d_key.bmp").c_str()), { 215, 110, 100, 100 });

            selected_wasd_[W] = Img(renderer_, SDL_LoadBMP((resource_path + "/rss/selected_w_key.bmp").c_str()), { 110, 5, 100, 100 });
            selected_wasd_[A] = Img(renderer_, SDL_LoadBMP((resource_path + "/rss/selected_a_key.bmp").c_str()), { 5, 110, 100, 100 });
            selected_wasd_[S] = Img(renderer_, SDL_LoadBMP((resource_path + "/rss/selected_s_key.bmp").c_str()), { 110, 110, 100, 100 });
            selected_wasd_[D] = Img(renderer_, SDL_LoadBMP((resource_path + "/rss/selected_d_key.bmp").c_str()), { 215, 110, 100, 100 });
        }
